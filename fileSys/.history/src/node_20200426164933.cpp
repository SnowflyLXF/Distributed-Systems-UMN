...
int Node::GetLoad(string c)
{
    ...
    sendto(_node_socket_fd, msg, len, 0, (struct sockaddr *)&_c_addr, _slen);
    len = sizeof("5055");
    snprintf(msg, len, "5055");
    sendto(_node_socket_fd, msg, len, 0, (struct sockaddr *)&_c_addr, _slen);
    len = sizeof("ajoy.txt");
    snprintf(msg, len, "ajoy.txt");
    sendto(_node_socket_fd, msg, len, 0, (struct sockaddr *)&_c_addr, _slen);
...
int Node::handleDownload(string dip, int dport, string file)
{
